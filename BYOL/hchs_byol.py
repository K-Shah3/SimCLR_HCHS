...
def get_datasets_from_path(testing_flag):
    if testing_flag:
        working_directory = 'byol_hchs_mesa_testing/'
    else:
        working_directory = 'byol_hchs_mesa/'
...
if __name__ == "__main__":
    testing_flag, batch_size, epoch_number, latent_dim, projection_dim, plotting_flag = True, 128, 3, 128, 128, False
    ...
    save_name = f'{start_time_str}-hchs-diabetes-only-metrics.pickle'
