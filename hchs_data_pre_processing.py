...
def normalise(data, means, stds):
    """
    Normalise along the column for activity and lights, based on the means and stds given
    Indices refer to the column indices for activity and all light colours
    """
